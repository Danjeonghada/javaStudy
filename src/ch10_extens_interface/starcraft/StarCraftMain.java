...
public class StarCraftMain {
	...
	public static void main(String[] args) {
		...
		marine02.move(100, 200);         // 부모기능
		marine01.stimpack();        	 // 자식기능
		System.out.println(marine02);
		...
		// highTemplar01, tthunderStorm();
		//다운캐스팅
		((HighTemplar)highTemplar01).tthunderStorm(); // 부모 -> 자식 형변환 후 사용 가능
		...
		System.out.println(scv instanceof Zealot); // 부모 객체는 자식 객체로 형변환 할 수 없음
